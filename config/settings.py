...
class EmbeddingSettings(BaseModel):
    ...
    dimensions: Optional[int] = Field(None, description="嵌入维度, 如果未设置则自动检测")
...
class RerankSettings(BaseModel):
    """重排序配置"""
    strategy: str = Field("auto", description="重排序策略: auto, api, cross_encoder, simple")
...
class PluginSettings(BaseModel):
    ...
    enable_kb_llm_enhancement: bool = Field(True, description="使用知识库内容增强LLM请求")
